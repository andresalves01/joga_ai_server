...
class Address(Model_ID):
    ...
    def from_dict(self, dictionary: dict[str, Any]) -> None:
        ...
        self.street = dictionary.pop("street", self.street)
        self.number = dictionary.pop("number", self.number)
        self.zipcode = dictionary.pop("zipcode", self.zipcode)
        self.complement = dictionary.pop("complement", self.complement)
        self.neighborhood = dictionary.pop("neighborhood", self.neighborhood)
        self.city_district = dictionary.pop("city_district", self.city_district)
        self.city = dictionary.pop("city", self.city)
        self.county = dictionary.pop("county", self.county)
        self.state = dictionary.pop("state", self.state)
        self.state_code = dictionary.pop("state_code", self.state_code)
        self.country = dictionary.pop("country", self.country)
        self.country_code = dictionary.pop("country_code", self.country_code)
        self.latitude = dictionary.pop("latitude", self.latitude)
        self.longitude = dictionary.pop("longitude", self.longitude)
